...
(z => {
        ...
        internal: {
            ...
            messaging: (() => {
                ...
                let v = () => {
                    ...
                    var m = (a, d, n) => {
                        if ("sendMessage" == a.type)
                            ...
                            var k = l[a.id];
                            if ("init" == a.reason)
                                k && console.warn("rea.messaging: port being overwritten!", a.id),
                                k = l[a.id] = B(a, d),
                                c(k.public);
                ...
                var B = (m, a) => {
                    ...
                    let w = {
                        handle: function(g, y) {
                            w && (w.cspmn = g.cspmn, f(y), "data" == g.reason ? n.forEach(A => {
                                A(g.data)
                            }) : "disconnect" == g.reason && (k.forEach(A => {
                                A()
                            }), r(), w = null))
                        },
                        public: {
    ...
    z.rea.extend({
        ...
        content: {
            onReady: function(b) {
                const c = () => {
                    "prerender" !== document.webkitVisibilityState && (document.removeEventListener("webkitvisibilitychange",
                    c, !1), b())
                };
